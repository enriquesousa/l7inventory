                ...
                <div class="login-form">
                  ...
                  <form>
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Nombre completo">
                    </div>
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control" id="exampleInputPasswordRepeat" placeholder="Confirmar Contraseña">
                    </div>
